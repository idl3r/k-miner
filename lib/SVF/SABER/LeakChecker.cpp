...
void
LeakChecker::writeToReport()
{
    std::stringstream rawReport;

    rawReport << "Use-After-Free Analysis Statistic:\n";
    rawReport << "======================================================\n";
